# 모두의 페스타 — 연인과 가족을 위한 전국 축제 지도

Next.js App Router + TypeScript / Supabase / Kakao Maps / Vercel.

## 축제 탐색

- 연인과 가족의 나들이를 위한 축제명·장소 검색, 시·도 및 시·군·구 선택, 날짜 직접 선택을 제공합니다.
- 기본 정렬은 종료일 가까운 순입니다. 개최 예정 먼저, 내 주변 거리순도 선택할 수 있습니다.
- 30일 이하 / 31일 이상 분류는 행사 전체 기간의 길이이며, 상설 공연 여부나 매일 운영 여부를 뜻하지 않습니다.
- `/saved`에서 날짜 필터에 관계없이 저장한 축제를 봅니다. 기존 브라우저 찜을 그대로 사용하며, 종료된 행사도 표시합니다. 12개씩 불러오고 조회 실패 시 개별 재시도할 수 있습니다.
